...
<div id="headlinks" class="headlinks">
	<ul>
		...
		if($_shop_total_cart>0) {
			echo '<li><a href="my-cart.php" title="Wishlist"><b>Wishlist (<span id="header_cart_items">'.$_shop_total_cart.'</span> items)</b></a></li>';
		} else { echo '<li><a href="my-cart.php" title="Wishlist">Wishlist (<span id="header_cart_items">0</span> items)</a></li>'; }
		?>		
		<li><a href="checkout.php" title="Checkout" style="border:0;">Quote &raquo;</a></li>
	</ul>
	<div class="clear"></div>
</div>
