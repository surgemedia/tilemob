...
if($category)
{
   $query .= "AND sw.Use LIKE '".$category."' ";
}
if($surface)
{
   $query .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query .= "AND sw.Colour LIKE '".$colour."' ";
}
if($sliprating)
{
    $query.= "AND sw.SlipRating LIKE '".$sliprating."' ";
}
if($peirating)
{
    $query.= "AND sw.PeiRating LIKE '".$peirating."' ";
}
if($type)
{
    $query.= "AND sw.Type LIKE '".$type."' ";
}
if($pattern)
{
    $query.= "AND sw.Pattern LIKE '".$pattern."' ";
}
if($material)
{
    $query.= "AND sw.Material LIKE '".$material."' ";
}
if($thickness)
{
    $query.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query.= "AND sw.Edge LIKE '".$edge."' ";
}
...
if($category)
{
   $query1 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query1 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query1 .= "AND sw.Surface LIKE '".$surface."' ";
}
/*if($colour)
{
    $query1 .= "AND sw.Colour LIKE  '".$colour."' ";
}*/
if($sliprating)
{
    $query1.= "AND sw.SlipRating LIKE '".$sliprating."' ";
}
if($peirating)
{
    $query1.= "AND sw.PeiRating LIKE '".$peirating."' ";
}
if($type)
{
    $query1.= "AND sw.Type LIKE '".$type."' ";
}
if($pattern)
{
    $query1.= "AND sw.Pattern LIKE '".$pattern."' ";
}
if($material)
{
    $query1.= "AND sw.Material LIKE '".$material."' ";
}
if($thickness)
{
    $query1.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query1.= "AND sw.Edge LIKE '".$edge."' ";
}
...
///////////////////////////////////////////////////////END OPTION COLOR///////////////////////////////////////////////////////////////////
 ...
 if($category)
{
   $query2 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query2 .= "AND sw.Size LIKE '".$size."' ";
}
/*if($surface)
{
...
if($colour)
{
    $query2 .= "AND sw.Colour LIKE '".$colour."' ";
}
if($sliprating)
{
    $query2.= "AND sw.SlipRating LIKE '".$sliprating."' ";
}
if($peirating)
{
    $query2.= "AND sw.PeiRating LIKE '".$peirating."' ";
}
if($type)
{
    $query2.= "AND sw.Type LIKE '".$type."' ";
}
if($pattern)
{
    $query2.= "AND sw.Pattern LIKE '".$pattern."' ";
}
if($material)
{
    $query2.= "AND sw.Material LIKE '".$material."' ";
}
if($thickness)
{
    $query2.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query2.= "AND sw.Edge LIKE '".$edge."' ";
}
...
if($category)
{
   $query3 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query3 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query3 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query3 .= "AND sw.Colour LIKE '".$colour."' ";
}
/*if($sliprating)
{
    $query3.= "AND sw.SlipRating LIKE '".$sliprating."'";
}*/
if($peirating)
{
    $query3.= "AND sw.PeiRating LIKE '".$peirating."' ";
}
if($type)
{
    $query3.= "AND sw.Type LIKE '".$type."' ";
}
if($pattern)
{
    $query3.= "AND sw.Pattern LIKE '".$pattern."' ";
}
if($material)
{
    $query3.= "AND sw.Material LIKE '".$material."' ";
}
if($thickness)
{
    $query3.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query3.= "AND sw.Edge LIKE '".$edge."' ";
}
...
if($category)
{
   $query4 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query4 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query4 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query4 .= "AND sw.Colour LIKE '".$colour."' ";
}
if($sliprating)
{
    $query4.= "AND sw.SlipRating LIKE '".$sliprating."' ";
}
/*if($peirating)
{
    $query3.= "AND sw.PeiRating LIKE '".$peirating."'";
...
if($type)
{
    $query4.= "AND sw.Type LIKE '".$type."' ";
}
if($pattern)
{
    $query4.= "AND sw.Pattern LIKE '".$pattern."' ";
}
if($material)
{
    $query4.= "AND sw.Material LIKE '".$material."' ";
}
if($thickness)
{
    $query4.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query4.= "AND sw.Edge LIKE '".$edge."' ";
}
...
if($category)
{
   $query5 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query5 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query5 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query5 .= "AND sw.Colour LIKE  '".$colour."' ";
}
if($sliprating)
{
    $query5.= "AND sw.SlipRating LIKE '".$sliprating."'";
}
if($peirating)
{
    $query5.= "AND sw.PeiRating LIKE '".$peirating."'";
}
/*if($type)
{
    $query4.= "AND sw.Type LIKE '".$type."'";
...
if($material)
{
    $query5.= "AND sw.Material LIKE '".$material."'";
}
if($thickness)
{
    $query5.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query5.= "AND sw.Edge LIKE '".$edge."'";
}
...
if($category)
{
   $query6 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query6 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query6 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query6 .= "AND sw.Colour LIKE  '".$colour."' ";
}
if($sliprating)
{
    $query6.= "AND sw.SlipRating LIKE '".$sliprating."'";
}
if($peirating)
{
    $query6.= "AND sw.PeiRating LIKE '".$peirating."'";
}
if($type)
{
    $query6.= "AND sw.Type LIKE '".$type."'";
}
/*if($pattern)
{
...
if($material)
{
    $query6.= "AND sw.Material LIKE '".$material."'";
}
if($thickness)
{
    $query6.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query6.= "AND sw.Edge LIKE '".$edge."'";
}
...
if($category)
{
   $query7 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query7 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query7 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query7 .= "AND sw.Colour LIKE  '".$colour."' ";
}
if($sliprating)
{
    $query7.= "AND sw.SlipRating LIKE '".$sliprating."'";
}
if($peirating)
{
    $query7.= "AND sw.PeiRating LIKE '".$peirating."'";
}
if($type)
{
    $query7.= "AND sw.Type LIKE '".$type."'";
}
if($pattern)
{
...
/*if($material)
{
    $query7.= "AND sw.Material LIKE '".$material."'";
}*/
if($thickness)
{
    $query7.= "AND sw.Thickness LIKE '".$thickness."' ";
}
if($edge)
{
    $query7.= "AND sw.Edge LIKE '".$edge."'";
}
...
if($category)
{
   $query8 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query8 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query8 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query8 .= "AND sw.Colour LIKE  '".$colour."' ";
}
if($sliprating)
{
    $query8.= "AND sw.SlipRating LIKE '".$sliprating."'";
}
if($peirating)
{
    $query8.= "AND sw.PeiRating LIKE '".$peirating."'";
}
if($type)
{
    $query8.= "AND sw.Type LIKE '".$type."'";
}
if($pattern)
{
...
if($material)
{
    $query8.= "AND sw.Material LIKE '".$material."'";
}
/*if($thickness)
{
    $query8.= "AND sw.Thickness LIKE '".$thickness."' ";
}*/
if($edge)
{
    $query8.= "AND sw.Edge LIKE '".$edge."'";
}
...
if($category)
{
   $query9 .= "AND sw.Use LIKE '".$category."' ";
}
if($size)
{
    $query9 .= "AND sw.Size LIKE '".$size."' ";
}
if($surface)
{
   $query9 .= "AND sw.Surface LIKE '".$surface."' ";
}
if($colour)
{
    $query9 .= "AND sw.Colour LIKE  '".$colour."' ";
}
if($sliprating)
{
    $query9.= "AND sw.SlipRating LIKE '".$sliprating."'";
}
if($peirating)
{
    $query9.= "AND sw.PeiRating LIKE '".$peirating."'";
}
if($type)
{
    $query9.= "AND sw.Type LIKE '".$type."'";
}
if($pattern)
{
...
if($material)
{
    $query9.= "AND sw.Material LIKE '".$material."'";
}
if($thickness)
{
    $query9.= "AND sw.Thickness LIKE '".$thickness."' ";
}
/*if($edge)
{
    $query8.= "AND sw.Edge LIKE '".$edge."'";
