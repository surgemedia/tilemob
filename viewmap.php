...
function load() {
	...
	map.setCenter(new GLatLng(-27.412986,152.973804), 14);
	var marker = new GMarker(new GLatLng(-27.412986,152.973804));
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="700" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top">Showroom<br />4-6 Blackwood St (Cnr Samford Rd) <br />Mitchelton Queensland Australia 4053 </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
