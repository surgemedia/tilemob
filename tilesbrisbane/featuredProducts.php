...
<body class='grey_bg' ?>>
        ...
        function fixback($string)
        {
            ...
            if($_GET['subheading']!=""){
                ...
                $result_webitems = mysql_query("SELECT * FROM shop_webitems WHERE WebExport='YES' AND is_active='1' ".$new_queryis) or die(mysql_error());
            ...
            <div id="gallery" class="gallery">
                ...
                if($total_results>0) {
                    ...
                    $result_webitems = mysql_query("SELECT *, WebPricePce, TradePricePce, (WebPricePce+TradePricePce) as pricesum FROM shop_webitems WHERE WebExport='YES' AND is_active='1' ".$new_queryis." LIMIT $start_row,$results_per_page") or die(mysql_error());
