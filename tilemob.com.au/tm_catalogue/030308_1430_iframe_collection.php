<?
if(isset($_GET['tilecode']) && $_GET['tilecode'] != "") { $tilecode = $_GET['tilecode']; }
else { $tilecode = ""; }
if(isset($_GET['tilelink']) && $_GET['tilelink'] != "") { $tilelink = $_GET['tilelink']; }
else { $tilelink = ""; }
if(isset($_GET['remove']) && $_GET['remove'] != "") { $remove = $_GET['remove']; }
else { $remove = ""; }
