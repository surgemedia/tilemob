    ...
    <th width="710" scope="row"><table width="800" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th height="60" colspan="2" align="left" valign="bottom" background="<?=$server_dir_main?>images/bkg_header.gif" bgcolor="#f0f0f0" scope="row"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <th align="left" height="35" scope="row"><!-- TemplateBeginEditable name="Gallery Heading" --><img src="<?=$server_dir_main?>images/hdg_wall_bathrooms.gif" alt="Tiles/Wall/Bathrooms"/><!-- TemplateEndEditable --></th>
      ...
      <tr>
        ...
        <th valign="top" scope="row"><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <th height="300" scope="row"> <iframe src="iframe_display.php" name="iframe_display" width="300" height="310" scrolling="No" frameborder="0" id="iframe_display"></iframe></th>
            </tr>
            <tr>
              <th height="15" valign="top" scope="row"> </th>
            </tr>
            <tr>
              <th height="103" scope="row"> <iframe 
      ...
      <tr>
        <th height="140" colspan="2" align="left" valign="baseline" scope="row"><iframe src="<?=$server_dir_main?>iframe_collection.php" allowtransparency="true" name="iframe_collection" width="700" height="140" scrolling="Auto" frameborder="0" id="iframe_collection"></iframe></th>
      </tr>
      <tr>
