    ...
    <th width="710" scope="row"><table width="800" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th height="60" colspan="2" align="left" valign="bottom" background="<?=$server_dir_main?>images/bkg_header.gif" bgcolor="#f0f0f0" scope="row"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <th align="left" height="35" scope="row"><!-- TemplateBeginEditable name="Gallery Heading" --><img src="<?=$server_dir_main?>images/hdg_mosaics.gif" alt="Mosaics"/><!-- TemplateEndEditable --></th>
      ...
      <tr>
        ...
        <th valign="top" scope="row"><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <th scope="row"> <!--<iframe onload="disableContextMenu();" src="iframe_display.php" name="iframe_display" width="300" height="310" scrolling="No" frameborder="0" id="iframe_display"></iframe>-->  <iframe onload="disableContextMenu();" 
			src="iframe_display_info.php" name="iframe_display_info" width="300" height="450" scrolling="No" frameborder="0" id="iframe_display_info"></iframe></th>
            </tr>
          </table></th>
        </tr>
