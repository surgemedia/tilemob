...
if(!empty($_GET['open'])) {
	...
	$open = 'gallery/tiles/floors/commercial/page1/index.php?page=1';
}
?>
...
$current_page_url = 'tilemob.com.au/tm_catalogue';
...
<title>Tiles Brisbane Tile Showroom | stone mosaics slate tiles terracotta ceramic tiles | Brisbane Floor & Wall Tile Supplies | Complete Tile Range Brisbane QLD | tilemob.com.au/tm_catalogue/</title>
<script>
...
<div id="container" class="container">
	...
	<div id="page_body" class="page_body">
		...
		src="<?php echo $open; ?>" onload="disableContextMenu();">
		</iframe>
		</div>
		</div>
		<div class="clear"></div>
