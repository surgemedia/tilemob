...
function generateMessage() {
	global $auto_message, $message;
	$temp_message = "";
	$cookies_collection = array();	
	...
	$message = base64_encode($temp_message);
}
?>
<p></p>
<form id="enquiry_form" name="enquiry_form" onsubmit="return checkFields()" method="post" action="send_enquiry.php?message=<?=$message?>">
<table width="790" border="0">  
  <tr>
    <th width="50%" align="right" valign="top" scope="row"><table width="375" border="0" cellspacing="5">
      <tr>
        <th valign="top" class="Details" scope="row"><div align="right">You are: </div></th>
      ...
      <tr>
        <th valign="top" scope="row"><label>
          <div align="right" class="Details">Project Type: </div></th>
        <td align="left" class="Details">&nbsp;</td>
      ...
      <tr>
        <th scope="row"><div align="right"><span class="Details">Project Commence: </span></div></th>
        <td class="Details">&nbsp;</td>
    ...
    <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
      ...
      <tr>
        <th valign="top" scope="row"><div align="left"><span class="Details">Message:</span></div></th>
        </tr>
      <tr>
        <th valign="top" scope="row"><div align="left"><span class="Details">
          <textarea class="textfields2" name="textarea_message" cols="55" rows="10" id="textarea_message"><?=$auto_message?>
          </textarea>
        </span></div></th>
        </tr>
  ...
  <tr>
    ...
    <th valign="top" scope="row"><input class="btn_textfields" name="submit_form" type="submit" id="submit_form" value="Submit Enquiry" /></th>
  </tr>
</table>
</form> 
