...
<div class="container">
   ...
   <?
		$time = time();
   		if($_POST['name']!="" && $_FILES['pdf_file']['name']!="" && $_FILES['img_file']['name']!=""){
			...
			if($_FILES['pdf_file']['type'] == 'application/pdf') {  
				...
				$pdfs_upload = "INSERT INTO file_pdfs VALUES(NULL, '".$_POST['name']."', '".$uppic1."', '".$uppic2."', '".$_POST['collection']."', 1)";
		...
		echo $error_message;
   ?>
      <h1>Upload new PDFs under collection</h1>
      ...
      if(this.img_file.value==''){ alert('Have not upload image!'); this.img_file.focus(); return false}">
         <table width="460" border="0" cellspacing="0" cellpadding="3" class="table1" align="center">
			<tr>
               <td width="120" class="table1_body"><h3>Collection Page: </h3></td>
			...
			<tr>
               <td width="120" class="table1_body"><h3>PDF File: </h3></td>
