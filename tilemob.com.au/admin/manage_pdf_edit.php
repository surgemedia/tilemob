...
<div class="container">
   ...
   <div class="middle">
      <h1>Edit/Delete PDFs</h1>
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="20" bgcolor="#CCCCCC" align="center" valign="middle">PDF name</td>
                    <td height="20" bgcolor="#CCCCCC" align="center" valign="middle" colspan="2">Action</td>
                  </tr>
      <?
				  		if($_POST['client_id']!=""){
							$query0 = "UPDATE file_pdfs SET enable_option = 0 WHERE id = ".$_POST['client_id'];
							mysql_query($query0);
						}
				  		$page_count=20; //the limit values to show in each time
						$query = "SELECT * FROM file_pdfs WHERE enable_option = 1 ORDER BY id";
								...
								//--------------------------Content
									echo '
									  <tr>
										...
										<td width="40">
											<form action="pdf_edit.php" method="post">
											<input type="hidden" value="'.$row['id'].'" name="client_id">
