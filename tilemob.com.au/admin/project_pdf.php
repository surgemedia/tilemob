...
<div class="container">
   ...
   <?
		$time = time();
   		if($_POST['name']!="" && $_FILES['pdf_file']['name']!="" && $_FILES['img_file']['name']!=""){
			...
			if($_FILES['pdf_file']['type'] == 'application/pdf') {  
				...
				$pdfs_upload = "INSERT INTO file_projects VALUES(NULL, '".$_POST['name']."', '".$uppic1."', '".$uppic2."', 0, 1)";
		...
		echo $error_message;
   ?>
      <h1>Project management /Upload new jobs</h1>
      ...
      if(this.img_file.value==''){ alert('Have not upload image!'); this.img_file.focus(); return false}">
         <table width="460" border="0" cellspacing="0" cellpadding="3" class="table1" align="center">
			<tr>
               <td width="120" class="table1_body"><h3>PDF Project File: </h3></td>
               <td class="table1_body"><input type="file" name="pdf_file" ></td>
            </tr>
            <tr>
               <td class="table1_body"><h3>Display Image about work: *<br/> Just support JPG, PNG and GIF</h3></td>
