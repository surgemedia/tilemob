  ...
  <table width="790" border="0" cellpadding="0" cellspacing="1">
    ...
    <tr>
      <td height="20" align="center" valign="middle" scope="row"><span class="Details">
         ...
         <table width="150" height="15" border="0" cellpadding="1" cellspacing="0" bgcolor="#EE3B33">
            <tr>
               <td><table width="150" height="15" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
                     <tr>
                        <td align="center" valign="middle"><span style="color:#EE3B33;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;">Visit our Showroom </span></td>
                     </tr>
               </table></td>
            </tr>
         </table>
