...
<title>Booking Form - The Tile Mob Pty Ltd, Brisbane</title>
...
<body>
<p></p>
<form id="booking_form" name="booking_form" onsubmit="return checkFields()" method="post" action="process_booking_form.php">
