...
<title>In-Showroom Consultation Booking Form - The Tile Mob Pty Ltd, Brisbane</title>
<?
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="440" align="left" valign="middle"><table width="99%" border="0" cellspacing="20" cellpadding="0">
      <tr>
        <td><h2 style="font-family:Arial, Verdana;color:#AAAAAA;font-size:20px;font-weight:medium;">Book now for your free consultation with a tile expert...</h2>
...
<form id="booking_form" name="booking_form" onsubmit="return checkFields()" method="post" action="process_booking_form.php<? if($change_appointment==true){echo'?reschedule=true&booking_id='.$booking_code;}?>">
  <table width="790" border="0" cellpadding="0" cellspacing="1">
    <tr>
      <td height="25" align="center" valign="middle" scope="row"><table width="150" height="15" border="0" cellpadding="3" cellspacing="0">
        <tr>
          <td align="center" valign="middle" bgcolor="#EE3B33"><span style="color:#FFFFFF;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;">Visit our Showroom </span></td>
        </tr>
      </table>
      <span class="Details"><a name="calendar" id="calendar"></a></span></td>
      <th align="right" valign="top" scope="row">&nbsp;</th>
    </tr>
    <tr>
      <td height="20" align="center" valign="middle" scope="row"><span class="Details">
        <? 
		if($change_appointment == true){ echo'<h2 style="color:#EE3B33; font-size:16px;"><strong><img src="images/img_arrowbullet.gif" border="0" hspace="0px" align="absmiddle" vspace="4px">&nbsp;Consultation reschedule form </strong></h2>'; }
		else { echo'<h2 style="color:#EE3B33; font-size:16px;"><strong><img src="images/img_arrowbullet.gif" border="0" hspace="0px" align="absmiddle" vspace="4px">&nbsp;Make an In-Showroom Consultation Booking </strong></h2>'; }
		?>
      </span></td>
      <th align="right" valign="top" scope="row">&nbsp;</th>
    </tr>
    <tr>
      <th width="50%" align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr>
            <th valign="middle" scope="row"><div align="right" class="Details"><span class="style9">*</span>Project Type: </div></th>
            <td width="5" align="left" class="Details">&nbsp;</td>
            <td width="110" height="50" align="left" valign="middle" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="requireProjectType();">
		...
		?>
          ...
          <tr>
            <td colspan="2" align="right" valign="middle" scope="row"><span class="Details"><A HREF="#calendar" NAME="anchor1x" TITLE="CHOOSE A DATE" ID="anchor1x" onClick="return checkFields2();"><strong> CHOOSE <img src="images/calendar.gif" alt="CHOOSE A DATE" width="16" height="16" border="0" align="absmiddle" /> </strong></A></span></td>
		...
		?>
          ...
          <tr>
            <th align="left" valign="top" scope="row"></th>
            <th align="left" valign="top" scope="row">&nbsp;</th>
            <td height="35" align="left" valign="top" class="Details" scope="row"><select class="textfields2" name="textfield_bookinghour" id="textfield_bookinghour">
          <?
		  ...
		  ?>
              ...
              <select class="textfields2" name="textfield_bookingminute" id="textfield_bookingminute">
                <?
    ...
    <tr>
      <th align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <th align="right" valign="middle" scope="row"><span class="Details"><span class="style9">*</span>You
            are:</span></th>
          <td width="5" align="left" class="Details">&nbsp;</td>
          <td width="110" height="50" align="left" valign="middle" class="Details"><select class="textfields2" name="option_question1" id="select8">
              <option value="------ Make a Selection ------">------ Make a Selection ------</option>
              <?
      ...
      <th align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <th height="50" valign="middle" scope="row"><span class="Details">
        ...
        <tr>
          <th align="left" valign="bottom" scope="row"><table width="370" border="0" cellpadding="0" cellspacing="0" style="border:solid #FFFFFF; border-width:0px;">
              ...
              <tr>
                ...
                <td><span class="Details"><img src="images/txt_showroom.gif" alt="Showroom" vspace="3" border="0" /><br />
...
<DIV ID="testdiv1" STYLE="position:absolute;margin-left:210px;visibility:hidden;background-color:white;layer-background-color:white;font:11px Arial, Verdana, Helvetica, sans-serif;text-align:right;padding:4px;line-height:12px;"></DIV>
