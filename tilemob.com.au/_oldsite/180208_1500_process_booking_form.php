...
function sendBookingEmail($booking_id, $is_reschedule, $old_bookingtime) {
	...
	if($is_reschedule == true){
		...
		$subject = $yourname." has made an Appointment using the In-Showroom Consultation Booking form.";
		$subject2 = "TileMob.com.au - Thank you for your In-Showroom Consultation Booking form ".$yourname;
	}
