...
function residentialSelectAll() {
	...
	if(document.forms['booking_form'].residential_selection_all.checked == true) {
		alert("residential_select_all was checked! length is: "+document.forms['booking_form'].residential_selection.length);
		/*for(i=0;i<document.forms['booking_form'].residential_selection.length;i++){
  ...
  <table width="790" border="0">
    <tr>
      <th width="50%" align="right" valign="top" scope="row"><table width="375" border="0" cellspacing="5">
		...
		?>
          ...
          <tr>
            ...
            <td align="left" class="Details">&nbsp;</td>
            <td align="left" valign="top" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="requireProjectType();">
                <option value="------ Make a Selection ------">------ Make a Selection ------</option>
                <?
		...
		?>
          ...
          <tr>
			...
			<table width="330" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="padding:3px;border:solid #CCCCCC;border-width:1px;">
              <tbody id="residential_row">
                <tr>
                  <td height="20" colspan="4"><span class="Details">&nbsp;&nbsp;<strong>I will be selecting tiles for the following areas:</strong></span></td>
                  </tr>
                <tr>
                  <td width="20">
				  <?
                  ...
                  <td width="145"><span class="Details">Kitchen wall</span></td>
                  <td width="20">
				  <?
                  ...
                  <td width="145"><span class="Details">Laundry Wall &amp; Floor</span></td>
                </tr>
                <tr>
                  <td>
				  <?
                  ...
                  <td><span class="Details">Bathroom wall &amp; floor</span></td>
                  <td>
				  <?
                  ...
                  <td><span class="Details">Living area/Main area floors</span></td>
                </tr>
                <tr>
                  <td>
				  <?
                  ...
                  <td><span class="Details">Ensuite/Wall &amp; Floor</span></td>
                  <td>
				  <?
                  ...
                  <td><span class="Details">External floors/Driveway</span></td>
                </tr>
                <tr>
                  <td>
				  <?
                  ...
                  <td><span class="Details">Pool Tiles</span></td>
                  <td>
				  <?
                  ...
                  <td><span class="Details">Powder Room? </span></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td><input name="residential_selection_all" type="checkbox" id="residential_selection_all" value="checkbox" onclick="residentialSelectAll()"/></td>
                  <td><span class="Details">All Areas/Check All </span></td>
                </tr>
              </tbody>
            </table></th>
          </tr>
          <tr>
            <th colspan="3" align="right" valign="top" scope="row"><table width="340" border="0" cellspacing="0" cellpadding="0" style="padding:3px;border:solid #CCCCCC;border-width:1px;">
              <tbody id="commercial_row">
			  <tr>
                <td height="25" colspan="2"><span class="Details">&nbsp;&nbsp;<strong>I will be selecting tiles for the following areas: </strong></span></td>
              </tr>
              <tr>
                <td width="30" align="center" valign="top"><input name="commercial_selection" type="checkbox" id="commercial_selection" value="checkbox" checked="checked" disabled /></td>
                <td height="30" valign="top"><span class="Details">
                  <input name="textfield_commercial_custom" type="text" class="textfields2" id="textfield_commercial_custom" value="<?=$commercial_selection;?>" size="45" />
                </span></td>
              </tr>
			  </tbody>
            </table></th>
      ...
      <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
          <tr>
            <th height="40" align="left" valign="top" scope="row">&nbsp;</th>
          </tr>
          <tr>
            <th align="left" valign="top" scope="row"><span class="Details">Please specify your preferred consultation booking time below. Click 'CHOOSE' first to select a booking date from our pop-up calendar and then select a booking time. </span></th>
          </tr>
          <tr>
            <th align="left" valign="top" scope="row"><span class="Details"><span class="style9">*</span><strong>1. Select a booking date:</strong> </span></th>
          </tr>
          <tr>
		...
		?>
          ...
          <tr>
            <th align="left" valign="top" scope="row"><span class="Details"><span class="style9">*</span><strong>2. Select a booking time:</strong></span>			</th>
          </tr>
          <tr>
