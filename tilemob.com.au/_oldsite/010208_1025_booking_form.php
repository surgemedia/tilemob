...
<?
	...
	while($row = mysql_fetch_array($result)) {
		...
		$disabledDates[] = strtotime($startdate);
	}
?>
<?
...
function changeDayDate() {
	...
	<? if($bookinghour!=""){echo'document.forms[\'booking_form\'].textfield_bookinghour.value="'.$bookinghour.'"';}?>
}

function showSelectableDates() {
	...
	var selectedMonth = document.forms['booking_form'].textfield_bookingmonth.value;
	var mm = ["", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
	var numDays = new Date(selectedYear, mm.indexOf(selectedMonth), 0); //2008, 02, 0
	var daysInMonth = numDays.getDate(); //eg 28
	...
	for(var i=0; i<daysInMonth; i++) {
		...
		var daysofweek = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];
		if(daysofweek[temp_bookingdate.getDay()] != "Sunday") {
			if(i < 9){
	...
	var temp_bookingday = 1;
	<? if($bookingday!=""){echo'temp_bookingday ='.$bookingday;}?>;
	if(temp_bookingday != "" && temp_bookingday < 9 && temp_bookingday > 0){
		document.forms['booking_form'].textfield_bookingday.selectedIndex = (temp_bookingday.substring(1)) - 1;
	} else {
		document.forms['booking_form'].textfield_bookingday.selectedIndex = temp_bookingday - 1;
	}
}
</SCRIPT>
		...
		?>
          ...
          <tr>
            <th valign="top" scope="row"><div align="right" class="Details"><span class="style9">*</span>Your
                Address: </div></th>
            <td class="Details">&nbsp;</td>
            <td align="left" class="Details"><textarea class="textfields2" name="textarea_youraddress" cols="29" rows="2" id="textarea_youraddress"><?=$youraddress;?>
</textarea></td>
          </tr>
          <tr>
            <th valign="top" scope="row"> <div align="right" class="Details"><span class="style9">*</span>Project Type: </div></th>
            <td align="left" class="Details">&nbsp;</td>
            <td align="left" valign="top" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="javascript:document.forms['booking_form'].textfield_bookinghour.disabled = true; document.forms['booking_form'].textfield_bookingminute.disabled = true; document.forms['booking_form'].textfield_bookingdate.value = '';">
                <option value="------ Make a Selection ------">------ Make a Selection ------</option>
                <?
      ...
      <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
          ...
          <tr>
            <th colspan="2" align="left" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><select name="textfield_bookingmonth" id="textfield_bookingmonth" onchange="showSelectableDates(); changeDayDate();">
                <?
				//don't show months pass 3 months of current month
				$future_month1 = date("F", strtotime("-1 months first day"));
				$future_month2 = date("F", strtotime("+0 months first day"));
				$future_month3 = date("F", strtotime("+1 months first day"));
		  ...
		  ?>
              ...
              <input name="textfield_bookingdate" type="hidden" id="textfield_bookingdate" value="<?=$bookingdate;?>" /></td>
                <td width="100">
		<span class="Details">
		...
		function setMultipleValues3(y,m,d) {
			var mm = ["", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
			document.forms['booking_form'].textfield_bookingmonth.selectedIndex = m-1;
			document.forms['booking_form'].textfield_bookingday.selectedIndex = d-1;
		}
