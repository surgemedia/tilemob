    ...
    <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
      ...
      <tr>
		...
		<SCRIPT LANGUAGE="JavaScript">writeSource("jscal1x");</SCRIPT>
          <input class="textfields2" name="textfield_bookingdate" type="text" id="textfield_bookingdate" size="20" onchange="javascript:document.forms['booking_form'].textfield_bookinghour.disabled = true; document.forms['booking_form'].textfield_bookingminute.disabled = true;"/>
      ...
      <tr>
        <th colspan="2" valign="top" scope="row"><div align="left"><span class="Details">
          <textarea class="textfields2" name="textarea_message" cols="55" rows="12" id="textarea_message">Dear Tile Mob,
