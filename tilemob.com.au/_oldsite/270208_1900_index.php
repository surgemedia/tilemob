...
<table width="800" height="659" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
	  <td width="800" colspan="9"><div align="center"><img src="images/The-Tile-Mob.gif" alt="The Tile Mob" width="313" height="131" border="0"><br />
	    <table width="313" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><?php include("nav_main_home.inc");?></td>
          </tr>
        </table>
	  </div></td>
	</tr>
	<tr>
		<td width="800" height="401" colspan="4" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center"><a href="http://tilemob.com.au/booking_form.php" target="_blank" onmouseover="MM_swapImage('Visit our Showroom','','images/btn_showroomclick2.gif',1)" onmouseout="MM_swapImgRestore()"><img src="images/btn_showroomclick.gif" alt="Visit our Showroom" name="Visit our Showroom" width="160" height="60" border="0" id="Visit our Showroom" /></a></td>
          </tr>
        </table></td>
	...
	<tr>
		...
		<td><a href="http://www.tilemob.com.au/new-in-store.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('New in Store','','images/New-in-store-over.gif',1)"><img src="images/New-in-store.gif" name="New in Store" width="121" height="28" border="0"></a></td>
