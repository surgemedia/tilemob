...
if (isset($_GET['booking_code'])){
	...
	$yourphone2 = $_GET['yourphone2'];
	$yourcompany = $_GET['yourcompany'];
	$youremail = $_GET['youremail'];
	$youraddress = $_GET['youraddress'];
	$project_type = $_GET['project_type'];
	$project_commence = $_GET['project_commence'];
	$subject = $_GET['subject'];
	$subject2 = "TileMob.com.au - Thank you for your Booking Appointment form ".$yourname;
	$bookingdate = $_GET['bookingdate'];
	$bookinghour = $_GET['bookinghour'];
	$bookingminute = $_GET['bookingminute'];
	$message_body3 = $_GET['message_body3'];
    ...
    <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
      ...
      <tr>
        <th colspan="2" valign="top" scope="row"><div align="right" class="Details">
          <div align="left">
            <input class="textfields2" name="textfield_subject" type="text" id="textfield_subject" value="<? if($change_appointment==true){echo'I wish change my appointment booking date/time';}else{echo'I wish to book an appointment';} ?>" size="58"/>
          </div>
        </div></th>
        </tr>
      <tr>
