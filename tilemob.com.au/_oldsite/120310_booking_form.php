...
function checkFields() {
	...
	if(parseInt(document.forms['booking_form'].val1.value) + parseInt(document.forms['booking_form'].val2.value) != parseInt(document.forms['booking_form'].textfield_sum.value)) {
		emptyfields += "\n   *Please verify that you are a human user (enter the correct sum)";
	}
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="350" align="right" valign="bottom"><form id="retrieve_form" name="retrieve_form" method="post" action="booking_form.php" onSubmit="return checkRetrieveValid();">
        <div style="align:right;padding:10px;border-width:1px;border-left-style:solid;border-color:#D3D3D3;">
          ...
          <tr>
            <td height="20" colspan="3" align="left"><img src="images/the-tile-mob-location2.jpg" alt="Come visit The Tile Mob" width="229" height="157" border="0"/></td>
          </tr>
          <tr>
  ...
  <tr>
    <td height="20" colspan="2" align="left" valign="middle"><img src="images/img_horizontal.gif" border="0" width="100%" height="1px" vspace="3px"/></td>
  </tr>
</table>
  ...
  <table width="790" border="0" cellpadding="0" cellspacing="1">
    <tr>
      ...
      <th rowspan="2" align="center" valign="top" scope="row"><table width="370" border="0" cellpadding="0" cellspacing="0" style="border:solid #FFFFFF; border-width:0px;">
        ...
        <tr>
          <td width="130" align="center"><a href="http://www.tilemob.com.au/"><img src="images/img_tm_logo_02.gif" alt="The Tile Mob" width="100" height="70" border="0"/></a></td>
          <td align="left" valign="middle"><span class="Details"><img src="images/txt_showroom.gif" alt="Showroom" vspace="3" border="0" /><br />
    ...
    <tr>
      <td height="20" align="center" valign="middle" scope="row">
         <img src="images/txt_visitourshowroom.gif" alt="Visit our Showroom" />
         <span class="Details">
		   <? 
		if($change_appointment == true){ echo'<h2 style="color:#EE3B33; font-size:16px;margin-top:2px;"><strong><img src="images/img_arrowbullet.gif" border="0" hspace="0px" align="absmiddle" vspace="4px">&nbsp;Consultation reschedule form </strong></h2>'; }
		else { echo'<h2 style="color:#EE3B33; font-size:16px;margin-top:2px;"><strong><img src="images/img_arrowbullet.gif" border="0" hspace="0px" align="absmiddle" vspace="4px">&nbsp;Make an In-Showroom Consultation Booking </strong></h2>'; }
		?>
         </span></td>
    </tr>
    <tr>
      <th width="50%" align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr>
            ...
            <td height="50" align="left" valign="middle" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="requireProjectType();">
		...
		?>
			...
			<table width="227" border="0" cellspacing="0" cellpadding="0" style="padding:3px;border:solid #CCCCCC;border-width:1px;margin-right:3px;">              
              ...
              <tr>
                <td height="30" align="center" valign="top"><span class="Details">
                  <input name="textfield_commercial_custom" type="text" class="textfields2" id="textfield_commercial_custom" value="<?=$commercial_selection;?>" size="30" style="background:#F8F4BE;"/>
                </span></td>
              </tr>
            </table>
			</span>			</th>
          ...
          <tr>
            <td colspan="2" align="right" valign="middle" scope="row"><span class="Details"><A HREF="#" NAME="anchor1x" TITLE="CHOOSE A DATE" ID="anchor1x" onClick="checkFields2(); return false;"><strong> CHOOSE <img src="images/calendar.gif" alt="CHOOSE A DATE" width="16" height="16" border="0" align="absmiddle" /> </strong></A></span></td>
            <td align="left" valign="top" class="Details" scope="row"><select class="textfields2" name="textfield_bookingfulldate" id="textfield_bookingfulldate" onchange="changeDayDate();">
                  <?
		...
		?>
          ...
          <tr>
            <th align="left" valign="top" scope="row"></th>
            <th align="left" valign="top" scope="row">&nbsp;</th>
            <td height="35" align="left" valign="top" class="Details" scope="row"><select class="textfields2" name="textfield_bookinghour" id="textfield_bookinghour" style="z-index:1;">
          <?
		  ...
		  ?>
              ...
              <select class="textfields2" name="textfield_bookingminute" id="textfield_bookingminute" style="z-index:1;">
                <?
      ...
      <th width="50%" align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
            ...
            <td height="190" align="left" valign="bottom" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td align="left" valign="top"><span class="Details">
                  <textarea class="textfields2" name="textarea_projectaddress" cols="29" rows="2" id="textarea_projectaddress"><?=$project_address;?></textarea>
                </span></td>
              </tr>
              <tr>
		...
		?>
              ...
              <tr>
                ...
                <td align="left" valign="top">&nbsp;</td>
                <td align="left" valign="top"><span class="Details">
                  <input name="textfield_referer" type="text" class="textfields2" id="textfield_referer" value="<?=$project_referer_name;?>" size="30" />
                </span></td>
              </tr>
              <tr>
      ...
      <th align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <th align="right" valign="middle" scope="row"><span class="Details"><span class="style9">*</span>You
            are:</span></th>
          <td width="5" align="left" class="Details">&nbsp;</td>
          <td width="110" height="50" align="left" valign="middle" class="Details"><select class="textfields2" name="option_question1" id="option_question1" style="z-index:1;">
              <option value="------ Make a Selection ------">------ Make a Selection ------</option>
              <?
        ...
        <tr>
          <th valign="top" scope="row"><div align="right" class="Details"><span class="style9">*</span>Your
            Address: </div></th>
          <td class="Details">&nbsp;</td>
          <td align="left" valign="top" class="Details"><textarea class="textfields2" name="textarea_youraddress" cols="29" rows="2" id="textarea_youraddress" ><?=$youraddress;?></textarea></td>
        </tr>
        <tr>
      ...
      <th align="center" valign="top" bgcolor="#E5E5E5" scope="row"><table width="375" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <th align="center" valign="top" scope="row"><div align="left"><span class="Details">
              <textarea class="textfields2" name="textarea_message" cols="53" rows="6" id="textarea3" onclick="if(this.value=='Please edit your message here...'){this.value='';}" onblur="if(this.value==''){this.value='Please edit your message here...';}"><? if($change_appointment==true){echo $booker_comments;}else{echo'Please edit your message here...';} ?></textarea>
          </span></div></th>
        </tr>
        <tr>
          <th align="left" valign="bottom" scope="row"><table width="370" border="0" cellpadding="0" cellspacing="0" style="border:solid #FFFFFF; border-width:0px;">
              ...
              <tr>
                 <td height="20" colspan="2"><span class="style9">*</span><span class="Details">Please verify that you are a human user (solve the following sum):</span></td>
              </tr>
              <tr>
                 <td height="20" colspan="2">
					  ...
					  echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$val1.' + '.$val2.' = ';					  
					  ?>
					  <input name="textfield_sum" type="text" class="textfields2" id="textfield_sum" style="width:20px;" value="" size="30"/>
					  <input name="val1" type="hidden" id="val1" value="<?=$val1;?>" />
					  <input name="val2" type="hidden" id="val2" value="<?=$val2;?>" />
					  </span></td>
              </tr>
              <tr>
                 <td height="20" colspan="2">&nbsp;</td>
              ...
              <tr>
                <td width="130" align="center"><a href="http://www.tilemob.com.au/"><img src="images/img_tm_logo_03.gif" alt="The Tile Mob" width="100" height="70" border="0"/></a></td>
                <td align="left" valign="middle"><span class="Details"><img src="images/txt_showroom.gif" alt="Showroom" vspace="3" border="0" /><br />
                  4-6 Blackwood St (Cnr Samford Rd) <br />
                  Mitchelton Queensland Australia 4053 <br />
                  PH (07) 3355 5055</span></td>
        ...
        <tr>
          <th align="left" valign="bottom" scope="row"><img src="images/img_bformpics.jpg" alt="We source from the best manufacturers around the world to offer you Brisbane&rsquo;s widest selection of premium floor and wall tiles." width="370" height="70" border="0" /></th>
        </tr>
        <tr>
