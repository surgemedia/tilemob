	  ...
	  <td width="800" height="204" colspan="9"><div align="center"><img src="images/The-Tile-Mob.gif" alt="The Tile Mob" width="313" height="131" border="0"><br>
	    <table width="313" border="0" cellspacing="0" cellpadding="3">
          <tr>
            ...
            <td><a href="tm_catalogue/index.php?open=gallery/stone/page1/index.php?page=1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('stone','','images/btn_home_stone_1.gif',1)"><img src="images/btn_home_stone_0.gif" alt="stone" name="stone" width="57" height="21" border="0"></a></td>
