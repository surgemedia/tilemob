...
function checkFields2() {
	...
	if (emptyfields!= "") {
		...
		//alert('textfield_bookingdate is: '+document.forms['booking_form'].textfield_bookingdate.value);
		//hideTimes();
		//showSelectableDates();
		return true;
	}
...
changeDayDate = function() { //Check selected dates from pulldown and populates the hours/mins options for those days
	//alert("changeDayDate...");
      ...
      <th width="50%" align="right" valign="top" scope="row"><table width="375" border="0" cellspacing="5">
		...
		?>
          ...
          <tr>
            ...
            <td align="left" class="Details">&nbsp;</td>
            <td align="left" valign="top" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="javascript:changeDayDate();">
                <option value="------ Make a Selection ------">------ Make a Selection ------</option>
                <?
