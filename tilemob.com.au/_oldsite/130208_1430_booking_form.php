...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="right" valign="middle"><form id="retrieve_form" name="retrieve_form" method="post" action="booking_form.php">
        <div style="width:330px;border-left-width:1px;border-bottom-width:1px;border-right-width:0px;border-top-width:0px;border-style:solid;border-color:#CCCCCC;padding:10px;">
  ...
  <table width="790" border="0">
    <tr>
      <th width="50%" align="right" valign="top" scope="row"><table width="375" border="0" cellspacing="5">
          <tr>
            <td height="20" colspan="3" align="center" class="Details"><? 
		...
		?></td>
          ...
          <tr>
            <th align="right" valign="top" scope="row"><div align="right" class="Details"><span class="style9">*</span>Project Type: </div></th>
            <td align="left" class="Details">&nbsp;</td>
            <td width="110" height="30" align="left" valign="top" class="Details"><select class="textfields2" name="option_question2" size="1" id="option_question2" onchange="requireProjectType();">
		...
		?>
			...
			<table width="330" border="0" cellpadding="0" cellspacing="0" style="margin:0px;padding:0px;border:solid #CCCCCC;border-width:1px;">			
			   <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="bottom" colspan="2"><img src="images/img_horizontal.gif" border="0" width="95%" height="1px" vspace="3px"/></td>
                </tr>
                <tr>
                  <td align="left"><?
                  ...
                  <td align="left"><input name="residential_selection_all" type="checkbox" id="residential_selection_all" value="checkbox" onclick="residentialSelectAll()"/></td>
                  <td align="left"><span class="Details">All Areas/Select All </span></td>
                </tr>              
            </table></span></th>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" align="right" valign="middle" scope="row"><span class="Details"><A HREF="#" NAME="anchor1x" TITLE="CHOOSE A DATE" ID="anchor1x" onClick="checkFields2();"><strong> CHOOSE <img src="images/calendar.gif" alt="CHOOSE A DATE" width="16" height="16" border="0" align="absmiddle" /> </strong></A></span></td>
            <td align="left" valign="top" scope="row" class="Details"><select class="textfields2" name="textfield_bookingfulldate" id="textfield_bookingfulldate" onchange="changeDayDate();">
                  <?
		...
		?>
          ...
          <tr>
            <th align="left" valign="top" scope="row"></th>
            <th align="left" valign="top" scope="row">&nbsp;</th>
            <td align="left" valign="top" scope="row" class="Details"><select class="textfields2" name="textfield_bookinghour" id="textfield_bookinghour">
          <?
          ...
          <tr>
            <th height="25" colspan="3" align="center" valign="middle" scope="row"><img src="images/img_horizontal.gif" border="0" width="95%" height="1px" vspace="3px"/></th>
          </tr>
          <tr>
      ...
      <th width="50%" align="left" valign="top" scope="row"><table width="385" border="0" cellspacing="5">
          <tr>
            <th height="50" align="left" valign="top" scope="row">&nbsp;</th>
          </tr>
          <tr>
            <th height="40" align="left" valign="top" scope="row"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              <tr>
              ...
              <tr>
                ...
                <td align="left" valign="top"><span class="Details">
                  <select class="textfields2" name="option_question3" size="1" id="option_question3" >
                    <option value="------ Make a Selection ------">------ Make a Selection ------</option>
                    <?
		...
		?>
              ...
              <tr>
                ...
                <td align="left" valign="top">&nbsp;</td>
                <td align="left" valign="top"><span class="Details">
                  <select class="textfields2" name="preferred_consultant" id="preferred_consultant">
                    <option value="------ Make a Selection ------">------ Make a Selection ------</option>
                    <?
		...
		?>
          ...
          <tr>
            <th align="left" valign="bottom" scope="row"><table width="370" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid #FFFFFF; border-width:1px;">
                <tr>
                ...
                <tr>
                  ...
                  <td><span class="Details"><img src="images/txt_showroom.gif" vspace="3" border="0"><br />
