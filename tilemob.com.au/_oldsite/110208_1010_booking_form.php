      ...
      <th width="50%" align="right" valign="top" scope="row"><table width="375" border="0" cellspacing="5">
		...
		?>
			...
			<table width="330" border="0" cellpadding="0" cellspacing="0" style="margin:0px;padding:0px;border:solid #CCCCCC;border-width:1px;">			
			   <tr>
                ...
                <tr>
                  ...
                  <td align="left"><span class="Details">All Areas/Check All </span></td>
                </tr>
                <tr>
                  <td align="left"><?
          ...
          <tr>
			...
			<table width="340" border="0" cellspacing="0" cellpadding="0" style="padding:3px;border:solid #CCCCCC;border-width:1px;">              
			  <tr>
                <td height="25" align="left"><span class="Details">&nbsp;&nbsp;<strong>I will be selecting tiles for the following areas: </strong></span></td>
              </tr>
              <tr>
                <td height="30" align="center" valign="top"><span class="Details">
                  <input name="textfield_commercial_custom" type="text" class="textfields2" id="textfield_commercial_custom" value="<?=$commercial_selection;?>" size="50" />
                </span></td>
              </tr>
            </table>
			</span>
