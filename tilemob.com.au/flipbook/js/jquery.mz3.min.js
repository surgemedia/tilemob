...
var h=c.get("pagewidth"),b=c.get("pageheight"),h=g.width()/(i?h*2:h),b=g.height()/b,b=Math.min(1,h,b);a("head > meta[name=viewport]").attr("content","width=device-width,maximum-scale="+b+",minimum-scale="+b)}}var q=j,e=[],i="invalid",r=j,c={a:function(a,b,c){c||(c=typeof b==="number"?I:typeof b==="boolean"?p:t);this[a]={value:b,g:c}},set:function(a,b){if(typeof this[a]!=="undefined")this[a].value=this[a].g?this[a].g(b,this[a].value):b},get:function(a){return this[a].value}};this.f=function(a){if(Boolean(a)!==
...
"url")===j)return j;if(!(c(b,"width")===j||c(b,"height")===j)){var d=a("<div/>");return g(b,d)}},gif:function(a){return h.h(a)},img:function(b){var d=c(b,"src-alt")||c(b,"src");if(d)d=A(n,d);else return j;var e=a("<img/>");e.addClass("mz3-img");e.load(function(){e.css("width",this.naturalWidth+"px");e.css("height",this.naturalHeight+"px");g(b,e)});e.attr("src","images/blank.gif");e.data("src",d);return e},nav:o(j),snd:o(j),vid:function(b){var d={d:c(b,"src"),b:c(b,"src-alt-h264"),e:c(b,"src-alt-ogg"),
c:c(b,"src-alt-webm")},e={b:'video/mp4; codecs="avc1.42E01E, mp4a.40.2"',e:'video/ogg; codecs="theora, vorbis"',c:'video/webm; codecs="vp8, vorbis"'};if(!d.d&&!d.b&&!d.e&&!d.c)return j;else for(var f in d)d[f]&&(d[f]=A(n,d[f]));var i=a("<div/>"),h;if(G){h=a("<a/>");h.css("display","block");var l=c(b,"preview"),m=a("<img/>");m.addClass("mz3-img");m.attr("src","images/blank.gif");l?m.data("src",A(n,l)):m.data("src","images/video.png");m.css("width","100%");m.css("height","100%");h.append(m);l=navigator.userAgent.match(/iPhone/i)||
navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/Safari/i)&&!navigator.userAgent.match(/Chrome/i)?d.b:d.c;if(!l)for(f in d)if(d[f]){l=d[f];break}h.attr("href",l)}else h=a("<video/>");h.css("width","100%");h.css("height","100%");i.append(h);if(G)$element=g(b,i);else{p(c(b,"loop"),!0)&&h.attr("loop","loop");p(c(b,"autoplay"),!0)&&!c(b,"preview")&&h.attr("autoplay","autoplay");(window.orientation||c(b,"gui"))&&h.attr("controls","controls");h.one("loadedmetadata",function(){i.css("width",
this.videoWidth+"px");i.css("height",this.videoHeight+"px");var c=!1;a(this).click(function(){c?this.pause():this.play();c=!c});i.parent()[0].tagName.toLowerCase()==="a"&&i.unwrap();g(b,i)});h.one("error",k());$element=g(b,i);for(f in d)f==="flash"?d.d&&!d.b&&!d.e&&!d.c&&h.attr("src",d.d):d[f]&&($source=a("<source/>"),$source.attr("src",d[f]),$source.attr("type",e[f]),h.append($source));h[0].load()}return $element}};b.children().each(function(){var b=this.tagName.toLowerCase();h[b]?f.append(h[b](a(this))):
