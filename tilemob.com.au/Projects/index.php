...
<div id="container" class="container">
	...
	<div id="page_body" class="page_body">
		...
		<div id="page_body_full" class="page_body_full">
			<iframe src="projects.php?s=<?php echo strtotime('now'); ?>" name="Stack" width="910px"  frameborder="0" scrolling="no" id="iframe" onload='javascript:resizeIframe(this);' ></iframe>
