...
<title>Tiles Brisbane Tile Showroom | stone mosaics slate tiles terracotta ceramic tiles | Brisbane Floor & Wall Tile Supplies | Complete Tile Range Brisbane QLD | tilemob.com.au/contact-map/</title>
</head>
...
<div id="container" class="container">
	...
	<div id="page_header" class="page_header">
		...
		<img src="../images/page/06.jpg" alt="Contact us" border="0"/>
	</div>
	<div id="page_body" class="page_body">
		<div id="page_body_col1" class="page_body_col1" style="width:379px;"><?php echo $body; ?></div>
		<div id="page_body_col2" class="page_body_col2" style="width:480px;"><?php echo $body2; ?></div>
		<div class="clear"></div>
	</div>
