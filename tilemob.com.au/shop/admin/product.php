...
//Save content
if(($_POST['save1']||$_POST['save2']) && !empty($_POST['linkname']) && !empty($_POST['heading'])){
	$content_id = $_GET['id'];
	...
	<div id="middle" class="middle">
		...
		<div id="content" class="content">
			...
			<table width="100%" class="table2">
				...
				<tr>
				   <td><b>Page URL: </b></td>
				   <td colspan="3"><input name="pageurl" type="text" class="textfield1" id="pageurl" value="" DISABLED style="background:#EEEEEE;"/></td>
				</tr>
				<tr><td colspan="4"><hr/></td></tr>
				<tr>
					<td width="150"><b>Item is hidden: </b></td>
