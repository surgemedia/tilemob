			...
			$item_unit='pcs';
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						'<div class="thumb">
							...
							<div id="addtocart_button_'.$item_id.'" class="button"><a href="javascript:void(0);" title="add to cart" onclick="addToCart(\''.$_shop_user_id_encoded.'\',\''.$_shop_user_session.'\',\''.$item_code.'\',1,\''.$item_id.'\',\''.$item_buy.'\');">add to cart</a></div>
