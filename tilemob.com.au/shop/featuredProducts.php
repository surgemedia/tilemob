...
$heading         = $_GET['key'];
$sqlSearchFor    = mysql_query("SELECT Description FROM shop_sub_heading WHERE Code='$heading'") or die(mysql_error());
	...
	<div id="body" class="body">
		...
		<div id="body_right" class="body_right">
			...
			$total_results = 0;
				...
				$result_webitems = mysql_query("SELECT * FROM shop_webitems WHERE WebExport='YES' AND is_active='1' AND SubHeading = '$heading'") or die(mysql_error());
			...
			<div id="gallery" class="gallery">
				...
				if($total_results>0) {
					...
					$result_webitems = mysql_query("SELECT *, WebPricePce, TradePricePce, (WebPricePce+TradePricePce) as pricesum FROM shop_webitems WHERE WebExport='YES' AND is_active='1' AND SubHeading = '$heading' LIMIT $start_row,$results_per_page") or die(mysql_error());
			...
			$item_unit='pcs';
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						'<div class="thumb">
							...
							<div id="addtocart_button_'.$item_id.'" class="button"><a href="javascript:void(0);" title="add to cart" onclick="addToCart(\''.$_shop_user_id_encoded.'\',\''.$_shop_user_session.'\',\''.$item_code.'\',1,\''.$item_id.'\');">add to cart</a></div>
