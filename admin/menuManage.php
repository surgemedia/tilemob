...
//$arr = $_POST['is_active'];
$query  = "SELECT * FROM shop_heading ORDER BY recordListingID ASC";
...
if($_POST['submit']=="Update"){
	 ...
	 if($status == "Inactive")
	 {
         ...
         if(count($arr)){
	 foreach($arr as $val){
  		 $sql = "UPDATE shop_heading SET is_active = " . $status  . " WHERE heading_id = " . $val;
...
$(document).ready(function(){ 
	$(function() {
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("updateSort.php", order, function(theResponse , status){
	...
	<div id="middle" class="middle">		
		...
		<div id="content" class="content">
			<table id="content-table" width="100%" class="table1">
				<thead>
					<tr>
						<th align="left" colspan="2">Manage Menu</th>
                                        </tr>
				</thead>
				<tbody>
                                        <tr>
