                ...
                <div id="image" class="image">
                    <!-- image -->   
                        ...
                        <ul class="thumb-list">
                            ...
                            <li><a href="images/items/watermarked/<?=$secImages?>" title="<?php echo $item_Desc; ?>" class="lightbox" data-group="details-gallery"><img src="images/items/watermarked/<?=$secImages?>" class="" /></a></li>
                            <?php }}?>
